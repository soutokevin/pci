...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { body: @content.body, order: @content.order, title: @content.title } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { body: @content.body, order: @content.order, title: @content.title } }
